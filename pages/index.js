       ...
       <a href="https://www.instagram.com/infinitrinh/" target="_blank" rel="noreferrer"> Photography Instagram &crarr;</a>
          ...
          <div>
            ...
            <div  className={styles.card}>
              <p><title>Project Management Intern</title>Lumen Technologies<br /></p>
              <div className="date">June 2022 - Current</div>
              <br />  
            ...
            <div  className={styles.card}>
              <p><title>IAW Lab Leader &#40;Instructor&#41;</title>
                <br />Academic Resource Center; <br /> University of California&#44; Riverside</p>
                <div className="date"><br />May 2020 - June 2021</div>
                <br />
            ...
            <div  className={styles.card}>
              <p><title>IAW Reader &#40;Grader&#41;</title><br />Academic Resource Center; <br /> University of California&#44; Riverside</p>
              <div className="date"><br />May 2019 - June 2021</div>
            ...
            <div  className={styles.card}>
              <p><title>Research Assistant &#40;Embedded Systems&#41;</title> University of California&#44; Riverside; <br /></p>
              <div className="date">Sept&#46; 2018 - Sept&#46; 2019</div><br />
          ...
          >
            <h2>Volunter Experience</h2>
              <div>
                ...
                <div  className={styles.card}>
                  <p><title>Director</title><br /> Cutie &amp; Citrus Hack <br /></p>
                  <div className="date">May 2020 - June 2021</div><br />
                  <br />
                ...
                <div  className={styles.card}>
                  <p><title>Sponsorship Lead</title><br /> Cutie &amp; Citrus Hack <br /><br /></p>
                  <div className="date">May 2019 - May 2020</div>
                  <br />
                ...
                <div  className={styles.card}>
                  <p><title>Secretary</title><br /> Materials Research Society &#40;MRS&#41;<br /></p>
                  <div className="date">June 2019 - June 2020</div><br />
                  <br />
                ...
                <div  className={styles.card}>
                  <p><title>Historian</title><br /> Materials Research Society &#40;MRS&#41;<br /></p>
        ...
        <div 
          ...
          >
            ...
            <a href="https://jonathantrinh.vercel.app/" target="_blank" rel="noreferrer" className={styles.card}>
              ...
              <div className="date"><br />Aug. 2022 - Current</div>
          ...
          <a href="https://docs.google.com/document/d/1Xkci0hA98UrtymjMoVoA1M5H1dRsxnQ0aHoMEtcKdek/edit?usp=sharing" target="_blank" rel="noreferrer" className={styles.card}>
              ...
              <div className="date"><br /> Nov&#46; 2021 - Dec&#46; 2021</div>
          ...
          <a href="hhttps://docs.google.com/document/d/1K9Kk7v5S7woE3pdP6iqIU7xLfaW-thwBnI_xWZO0x8k/edit" target="_blank" rel="noreferrer" className={styles.card}>
            ...
            <div className="date"><br /> Sept&#46; 2021 - June 2021</div>
          ...
          <a href="https://docs.google.com/document/d/1pYLFrX4qAp_fLJdlanWYrLAlOdWDGDz_FReZX_Z_H0Q/edit" target="_blank" rel="noreferrer" className={styles.card}>
            ...
            <div className="date"><br /> July 2021 - Sept&#46; 2021</div>
          ...
          <a href="https://docs.google.com/presentation/d/120sBDQv1Sr-K6onshXQiYKaA25wh7cVHcz5I15wKU9Q/edit#slide=id.p" target="_blank" rel="noreferrer" className={styles.card}>
            ...
            <div className="date"><br />Sept 2018 - Sept&#46; 2019</div>
          ...
          <a href="https://docs.google.com/document/d/155uo9RAQhZOzTAOQ9Ve1RDytzQzga8hz/edit?usp=sharing&amp;ouid=109920275224725165600&amp;rtpof=true&amp;sd=true" target="_blank" rel="noreferrer" className={styles.card}>
            ...
            <div className="date"><br /> May 2019 - June 2019</div>
